...
```bash
git clone https://github.com/center-for-humans-and-machines/internship-hpc-repo-template EmotionsMechInt
cd EmotionsMechInt
```
...
- [notebooks/mi_analysis_notebook.ipynb](notebooks/mi_analysis_notebook.ipynb)
